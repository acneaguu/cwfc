...
parameter.n_random_ini =round(0.80*ps.D/1.0);    %initial number of variables selected for mutation ;  
parameter.n_random_last=round(0.25*ps.D/1.0);    %final number of variables selected for mutation 
